...
public class ApproximationExperimentRunner {

	private static Logger logger = Logger.getLogger(ApproximationExperimentRunner.class);
	...
	public ApproximationExperimentRunner(File config) throws Exception {
		// parse input XML
	...
	public static void main(String[] args) throws Exception {
		if (args.length != 1) {
			System.out.println("Usage: ApproximationExperimentRunner <config>");
			System.exit(0);
		}
		
		new ApproximationExperimentRunner(new File(args[0]));
	}
