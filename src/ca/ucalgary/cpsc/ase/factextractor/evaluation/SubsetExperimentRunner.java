...
public class SubsetExperimentRunner {

	private static Logger logger = Logger.getLogger(SubsetExperimentRunner.class);
	...
	private static final String VARIATION_SUT = "sut";
	...
	public SubsetExperimentRunner(File config) throws Exception {
		// parse input XML
		...
		while (i.hasNext()) {
		    ...
		    while (iterator.hasNext()) {
		    	...
		    	String sut = variation.attributeValue(VARIATION_SUT);
				...
				// fetch
				Map<Integer, VotingResult> results = manager.simulateInterfaceBasedRetrieval(query, sut);
